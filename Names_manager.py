...
"""
Documentation:www.github.com
"""
def JokeMaker(joke_type):
    accountant_jokes = [
        ...
        "You Might Be An Accountant If you refer to your child as Deduction 214.",
    ...
    if joke_type == 'accountant jokes':
        random_item = random.choice(accountant_jokes)
        print(random_item)
    if joke_type == 'chuck':
        random_item = random.choice(chuck)
        print(random_item)
    if joke_type == 'neutral':
        random_item = random.choice(neutral)
        print(random_item)
...
def zip_input(list1, list2):
    return list(zip(list1, list2, fillvalue = 'missing'))
